...
base_url = 'https://pubmed.ncbi.nlm.nih.gov/?term=Cancer+pain+management&page={}'
...
try:
    ...
    with open('pubmed_t&a_cancer_pain.txt', 'a', encoding='utf-8') as title_file, \
            open('pubmed_l_cancer_pain.txt', 'a', encoding='utf-8') as link_file:
