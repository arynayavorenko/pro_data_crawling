...
base_url = 'https://pubmed.ncbi.nlm.nih.gov/?term=Psychological+approaches+to+pain+management&page={}'
...
try:
    ...
    with open('pubmed_t&a_psycological_approaches.txt', 'a', encoding='utf-8') as title_file, \
            open('pubmed_l_psycological_approaches.txt', 'a', encoding='utf-8') as link_file:
