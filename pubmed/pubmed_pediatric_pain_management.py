...
base_url = 'https://pubmed.ncbi.nlm.nih.gov/?term=Pediatric+pain+management&page={}'
...
try:
    ...
    with open('pubmed_t&a_pediatric_pain.txt', 'a', encoding='utf-8') as title_file, \
            open('pubmed_l_pediatric_pain.txt', 'a', encoding='utf-8') as link_file:
