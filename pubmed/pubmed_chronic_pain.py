...
base_url = 'https://pubmed.ncbi.nlm.nih.gov/?term=Chronic+pain+treatment&page={}'
...
try:
    ...
    with open('pubmed_t&a_chronic_pain.txt', 'a', encoding='utf-8') as title_file, \
            open('pubmed_l_chronic_pain.txt', 'a', encoding='utf-8') as link_file:
