...
base_url = 'https://pubmed.ncbi.nlm.nih.gov/?term=Physical+therapy+for+pain&page={}'
...
try:
    ...
    with open('pubmed_t&a_physical_therapy.txt', 'a', encoding='utf-8') as title_file, \
            open('pubmed_l_physical_therapy.txt', 'a', encoding='utf-8') as link_file:
