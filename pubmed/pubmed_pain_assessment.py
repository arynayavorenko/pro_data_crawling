...
base_url = 'https://pubmed.ncbi.nlm.nih.gov/?term=Pain+assessment&page={}'
...
try:
    ...
    with open('pubmed_t&a_pain_assessment.txt', 'a', encoding='utf-8') as title_file, \
            open('pubmed_l_pain_assessment.txt', 'a', encoding='utf-8') as link_file:
